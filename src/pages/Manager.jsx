              ...
              <Card>
                ...
                <div className='layer-controls'>
                  <Checkbox
                    ...
                    onChange={e => handleLayerToggle('vung', e.target.checked)}
                  >
                    Vùng chè
                  </Checkbox>
                  <Checkbox
                  ...
                  <Form layout='vertical'>
                    ...
                    <Form.Item label='Giống'>
                      ...
                      >
                        ...
                        <Option value='Trà Shan Tuyết Cổ Thụ'>
                          Trà Shan Tuyết Cổ Thụ
                        </Option>
                        <Option value='Trà Mộc Châu'>Trà Mộc Châu</Option>
                        <Option value='Trà Cầu Đất'>Trà Cầu Đất</Option>
                        <Option value='Trà Ô Long Lâm Đồng'>
                          Trà Ô Long Lâm Đồng
                        </Option>
                        <Option value='Giống chè TRI777'>
                          Giống chè TRI777
                        </Option>
                        <Option value='Giống chè PH1'>Giống chè PH1</Option>
                        <Option value='Giống chè LDP1'>Giống chè LDP1</Option>
                        <Option value='Giống chè Shan'>Giống chè Shan</Option>
                        <Option value='Giống chè Ô Long'>
                          Giống chè Ô Long
                        </Option>
                        <Option value='Trà Xanh'>Trà Xanh</Option>
                        <Option value='Trà Đen'>Trà Đen</Option>
                        <Option value='Trà Ô Long chế biến'>
                          Trà Ô Long chế biến
                        </Option>
                        <Option value='Trà Trắng'>Trà Trắng</Option>
                        <Option value='Trà Phổ Nhĩ'>Trà Phổ Nhĩ</Option>
                        <Option value='Trà ướp hương'>Trà ướp hương</Option>
                      </Select>
                    </Form.Item>
                ...
                <Modal
                  title={userEdit ? 'Sửa người dùng' : 'Tạo người dùng mới'}
                  open={modalThemUser}
